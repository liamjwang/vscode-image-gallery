...
export default class HTMLProvider {
	...
	toolbarHTML() {
		...
		<div class="toolbar">
			...
			<div class="thumbnail-size-control">
				<span>Size</span>
				<input type="range" id="thumbnail-size-slider" class="thumbnail-slider" min="150" max="1024" value="250" step="25">
			</div>
			<div class="search-control">
				<span>Search</span>
				<input type="text" id="search-input" class="search-input" placeholder="Filter images...">
			</div>
	...
	folderBarHTML(folder: TFolder, collapsed: boolean = false) {
		...
		<button
			...
			data-loaded="${folder.loaded !== false}"
			class="folder"
		>
			<div
				id="${folder.id}-arrow"
